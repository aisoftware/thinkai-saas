...
//     <div className="">
//       <div className="">
//         <label htmlFor={"result-" + selected?.name.toLowerCase().replace(" ", "")} className="block text-xs font-medium text-foreground/80">
...
//             id="result"
//             value={result}
//             className=" block w-full cursor-not-allowed rounded-md border-border bg-secondary/90 shadow-2xs focus:border-theme-500 focus:ring-ring sm:text-sm"
//           />
...
//       {showFormulaInput && (
//         <div className="">
//           <label htmlFor={"formula-" + selected?.name.toLowerCase().replace(" ", "")} className="block text-xs font-medium text-foreground/80">
//             Formula tests
//           </label>
//           <div className="mt-1">
//             <input
...
//               className="  block w-full rounded-md border-border shadow-2xs focus:border-theme-500 focus:ring-ring sm:text-sm"
//             />
//           </div>
//         </div>
//       )}
