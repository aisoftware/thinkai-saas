    ...
    <Dialog open={open} onClose={setOpen} className="fixed inset-0 z-50 overflow-y-auto transition duration-300 ease-out data-[closed]:opacity-0" transition>
      <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="bg-background inline-block w-full transform overflow-hidden rounded-lg px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6 sm:align-middle">
            <div>
            ...
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
              <button
                ...
                onClick={no}
                data-autofocus
                className="hover:bg-secondary border-border bg-background text-foreground/80 mt-3 inline-flex w-full justify-center truncate rounded-md border px-4 py-2 text-base font-medium shadow-2xs focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-hidden sm:col-start-1 sm:mt-0 sm:text-sm"
              >
                {noTitle}
              </button>
              <ButtonPrimary
                ...
                className="inline-flex w-full justify-center truncate rounded-md border border-transparent px-4 py-2 text-base font-medium shadow-2xs focus:ring-2 focus:ring-offset-2 focus:outline-hidden sm:col-start-2 sm:text-sm"
              >
                {yesTitle}
              </ButtonPrimary>
            </div>
