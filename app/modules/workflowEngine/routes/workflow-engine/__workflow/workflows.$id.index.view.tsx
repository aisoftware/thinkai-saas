          ...
          <div className="flex items-center space-x-2">
            {/* {WorkflowUtils.canRunManually(workflow) && (
              <button
                type="button"
                className={clsx(
                  "rounded px-2 py-1 text-sm font-semibold text-foreground/80 shadow-2xs ring-1 ring-inset ring-gray-300",
                  WorkflowUtils.isReady(workflow) ? "bg-background hover:bg-secondary" : "bg-secondary/90 cursor-not-allowed"
                )}
