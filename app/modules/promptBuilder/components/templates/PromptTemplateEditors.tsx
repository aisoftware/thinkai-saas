          ...
          <div className="flex justify-between space-x-2">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className={clsx(!sampleSourceRow ? "text-muted-foreground cursor-not-allowed opacity-50" : "hover:text-gray-800")}
              >
              ...
              <button type="button" onClick={() => setShowHelp(true)}>
                <QuestionMarkFilledIcon className="text-muted-foreground h-5 w-5 cursor-pointer hover:text-gray-800" />
              </button>
              <button type="button" onClick={onToggleExpanded}>
                {isExpanded ? (
                  <ArrowsPointingIn className="text-muted-foreground h-5 w-5 cursor-pointer hover:text-gray-800" />
                ) : (
                  <ArrowsPointingOut className="text-muted-foreground h-5 w-5 rotate-180 transform cursor-pointer hover:text-gray-800" />
                )}
              </button>
            </div>
            {/* {value.source && (
      ...
      <div className="border-border space-y-2 border-t pt-2">
        <div className="flex items-center space-x-2">
          <div className="w-1/2 space-y-1">
            ...
            <div className="border-border text-muted-foreground bg-secondary/90 h-[calc(100vh-250px)] overflow-y-scroll break-words rounded-md border p-2">
              {result}
            </div>
          </div>
          ...
          <div className="w-1/2 space-y-1">
            <div className="flex justify-between space-x-2">
              ...
              >
                <ClipboardIcon className="text-muted-foreground h-5 w-5 hover:text-gray-800" />
              </button>
            </div>
            <div className="border-border text-muted-foreground bg-secondary/90 h-[calc(100vh-250px)] overflow-y-scroll break-words rounded-md border p-2">
