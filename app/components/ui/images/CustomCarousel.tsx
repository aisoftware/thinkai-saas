      ...
      <div className="relative mx-auto w-full">
        ...
        {false && (
          <Fragment>
            ...
            <div className="border-border relative block w-full overflow-hidden rounded-lg border-4 border-dotted focus:outline-hidden focus:ring-2 focus:ring-indigo-600 focus:ring-offset-0 lg:h-[32rem]">
              <div className="absolute top-0 ml-2 mt-3">
                <button
                  onClick={previousImage}
                  type="button"
                  className={clsx(
                    "border-theme-500 bg-theme-900 text-theme-300 hover:bg-theme-800 focus:ring-ring absolute rounded-full border p-2 opacity-90 focus:outline-hidden focus:ring-2 focus:ring-offset-0",
