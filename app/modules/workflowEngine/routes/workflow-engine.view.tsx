...
import WorkflowCredentialIcon from "~/modules/workflowEngine/components/icons/WorkflowCredentialIcon";
import WorkflowCredentialIconFilled from "~/modules/workflowEngine/components/icons/WorkflowCredentialIconFilled";
  ...
  return (
    <SidebarIconsLayout
      ...
      items={[
        ...
        {
          name: "Credentials",
          href: UrlUtils.getModulePath(params, `workflow-engine/credentials`),
          icon: <WorkflowCredentialIcon className="h-5 w-5" />,
          iconSelected: <WorkflowCredentialIconFilled className="h-5 w-5" />,
        },
        {
          name: "Executions",
