...
export default function WorkflowsIdRunStreamView() {
  const data = useLoaderData<WorkflowsIdRunStreamApi.LoaderData>();
  const actionData = useActionData<WorkflowsIdRunStreamApi.ActionData>();
  ...
  return (
    <div>
      <div className="border-border w-full border-b bg-white px-4 py-2 shadow-sm">
        <BreadcrumbSimple
      ...
      <div className="border-border w-full border-b bg-white px-4 py-2 shadow-sm">
        <div className="flex justify-between">
          <Link
            ...
            className="text-muted-foreground rounded bg-white px-2 py-1 text-sm font-semibold shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
          >
