import { ActionFunctionArgs, LoaderFunction, MetaFunction, useActionData, useLoaderData } from "react-router";
import { PromptFlowGroup } from "@prisma/client";
import { useTranslation } from "react-i18next";
import { Link, Outlet, useNavigate, useNavigation, useSubmit } from "react-router";
...
//           <h3 className="text-lg font-medium leading-6">Execute Prompt Flow</h3>
//         </div>
//         {!flow ? (
//           <></>
//         ) : (
...
//                   <label className="truncate text-xs font-medium text-muted-foreground">Variables</label>
//                   <div className="relative mt-1 grid rounded-md border border-border bg-secondary/90 p-1 sm:grid-cols-2 md:grid-cols-3">
//                     {PromptFlowUtils.getVariablesNeeded(flow!, entities).map((v, idx) => {
//                       return (
//                         <div key={v.name} className="space-y-1 truncate p-1">
//                           <label htmlFor={v.name} className="truncate text-xs font-medium text-muted-foreground">
//                             {v.name}
//                           </label>
//                           <input
//                             autoFocus={idx === 0}
