          ...
          return (
            <Fragment key={idx}>
              <div className={clsx("group relative", item.header && "z-10")}>
                ...
                <div
                  className={clsx(
                    editor && "group-hover:border-border rounded-md rounded-t-none border-2 border-b-0 border-t-0 border-dashed border-transparent",
              ...
              {Object.keys(PageBlockUtils.defaultBlocks).map((type) => {
                return (
                  <button
                    ...
                    className="border-border bg-secondary hover:bg-secondary/90 focus:bg-secondary/90 group flex w-full flex-col items-center space-y-2 rounded-md border-2 border-dashed p-2 hover:border-gray-800 focus:border-transparent focus:outline-hidden focus:ring-2 focus:ring-gray-800"
                  >
