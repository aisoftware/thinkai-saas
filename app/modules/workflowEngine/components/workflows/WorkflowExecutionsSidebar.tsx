      ...
      <div className="space-y-1">
        ...
        <div className="flex flex-col space-y-2">
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/manual`)}>
            <div className="border-border bg-secondary hover:bg-secondary/90 hover:border-border rounded-md border border-dashed p-3 hover:border-dotted">
              <div className="space-y-1">
          ...
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/stream`)}>
            <div className="border-border bg-secondary hover:border-border hover:bg-secondary/90 rounded-md border border-dashed p-3 hover:border-dotted">
              <div className="space-y-1">
                <div className="text-sm font-medium text-gray-800">Stream</div>
                <div className=" text-muted-foreground text-xs">Get interactive output from the workflow.</div>
              </div>
            </div>
          </Link>
        </div>
