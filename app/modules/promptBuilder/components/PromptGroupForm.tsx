          ...
          <div className="space-y-2">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between space-x-2 text-xs">
                <label className="text-muted-foreground font-medium">{t("prompts.templates")}</label>
              ...
              <div className="">
                ...
                <button
                  ...
                  className="border-border text-muted-foreground hover:bg-secondary/90 mt-2 flex items-center space-x-1 rounded-md border bg-white px-2 py-1 text-xs focus:text-gray-800 focus:ring focus:ring-gray-300 focus:ring-offset-1"
                >
