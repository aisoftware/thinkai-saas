          ...
          {state.links.map((link, index) => (
            <div key={index} className="group relative grid grid-cols-4 gap-2">
              <button
                ...
                type="button"
                className="bg-background text-muted-foreground absolute right-0 top-0 -mt-3 hidden origin-top-right justify-center rounded-full hover:text-red-500 group-hover:flex"
              >
