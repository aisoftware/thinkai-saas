  ...
  return (
    <>
      {title ? (
        ...
        <CheckIcon className={clsx(className, "h-5 w-5 shrink-0")} />
        ...
        <PaperClipIcon className={clsx(className, "h-5 w-5 shrink-0")} />
      ) : type === PropertyType.FORMULA ? (
        <ExperimentIconFilled className={clsx(className, "h-5 w-5 shrink-0")} />
      ) : (
        <div></div>
      )}
    </>
