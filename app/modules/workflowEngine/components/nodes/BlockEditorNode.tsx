      ...
      <div className="w-full space-y-2">
        ...
        {errors.length > 0 ? (
          ...
          <div className=" text-muted-foreground line-clamp-1 text-xs">
            {workflowBlock.appliesToAllTenants && !params.tenant && <span className="text-xs text-blue-500">(All accounts) </span>}
        ...
        {/* {workflowBlock.appliesToAllTenants && (
          <Fragment>
            <div className="absolute right-0 top-0 p-1">
              <div className="rounded-full bg-secondary/90 px-2 py-1 text-xs text-muted-foreground">Applies to all tenants</div>
            </div>
          </Fragment>
        )} */}
