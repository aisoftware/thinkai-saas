...
export default function WorkflowsDangerView() {
  const data = useLoaderData<WorkflowsDangerApi.LoaderData>();
        ...
        <div className="divide-y-gray-200 mt-6 space-y-8 divide-y">
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
            <div className="sm:col-span-6">
              ...
              <p className="text-muted-foreground mt-1 text-sm">Delete all workflows data.</p>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-2 pt-8">
            <DropdownOptions
              width="w-80"
              button={
                <div className="hover:bg-secondary border-border bg-background rounded-md border px-2 py-2 text-sm font-medium text-red-600">Reset data</div>
              }
              options={
                <div>
                  {[
