  ...
  articles: [
    {
      ...
      order: 0,
      contentDraft:
        '<p></p><p>Watch the demo video: <a target="_blank" rel="noopener noreferrer nofollow" class="text-muted-foreground underline underline-offset-[3px] hover:text-foreground transition-colors cursor-pointer" href="https://www.loom.com/share/85f9fdc37ae84896af52a3ba79952c01?sid=34b5db31-01d6-47d1-ace7-68d143c1d285"><span>https://www.loom.com/share/85f9fdc37ae84896af52a3ba79952c01?sid=34b5db31-01d6-47d1-ace7-68d143c1d285</span></a></p>',
      contentPublished:
        '<p></p><p>Watch the demo video: <a target="_blank" rel="noopener noreferrer nofollow" class="text-muted-foreground underline underline-offset-[3px] hover:text-foreground transition-colors cursor-pointer" href="https://www.loom.com/share/85f9fdc37ae84896af52a3ba79952c01?sid=34b5db31-01d6-47d1-ace7-68d143c1d285"><span>https://www.loom.com/share/85f9fdc37ae84896af52a3ba79952c01?sid=34b5db31-01d6-47d1-ace7-68d143c1d285</span></a></p>',
    ...
    },
    {
      ...
      order: 0,
      contentDraft:
        '<h3><strong>Static Knowledge Base</strong></h3><p>This /docs knowledge base is "static", meaning there are the following route files:</p><ul class="list-disc list-outside leading-3"><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).tsx</code></p></li><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).categories.$category.tsx</code></p></li><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).articles.$article.tsx</code></p></li></ul><p>And the knowledge base <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">slug</code> is manually set. This means, there needs to be a knowledge base created with the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">knowlegeBase.slug = "docs"</code> and the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">knowlegeBase.basePath = "/"</code>.</p><p><strong>app/routes/docs/($lang).tsx</strong>:</p><pre class="rounded-sm bg-secondary text-secondary-foreground p-5 font-mono font-medium"><code>import type { LoaderFunctionArgs, MetaFunction } from "react-router";\nimport KbRoutesIndex from "~/modules/knowledgeBase/routes/views/KbRoutes.Index.View";\nimport { KbRoutesIndexApi } from "~/modules/knowledgeBase/routes/api/KbRoutes.Index.Api";\nimport ServerError from "~/components/ui/errors/ServerError";\n\nexport const meta: MetaFunction = ({ data }) =&gt; data?.metatags;\nexport const loader = (args: LoaderFunctionArgs) =&gt; KbRoutesIndexApi.loader(args, {\n  kbSlug: "docs"\n});\n\nexport default () =&gt; &lt;KbRoutesIndex /&gt;;\n\nexport function ErrorBoundary() {\n  return &lt;ServerError /&gt;;\n}</code></pre><h3><strong>Dynamic Knowledge Bases</strong></h3><p>For all other knowledge bases, the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">basePath</code> needs to be <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">/help</code>. And if you need a Help Center knowledge base, you would set the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">slug</code> as <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">center</code>. This will result in a <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">/help/center</code> route for the knowledge base.</p><p>You can change the hard-coded <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">docs</code> and <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">help</code> directories to fit your knowledge base needs.</p>',
      contentPublished:
        '<h3><strong>Static Knowledge Base</strong></h3><p>This /docs knowledge base is "static", meaning there are the following route files:</p><ul class="list-disc list-outside leading-3"><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).tsx</code></p></li><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).categories.$category.tsx</code></p></li><li class="leading-normal"><p><code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">app/routes/docs/($lang).articles.$article.tsx</code></p></li></ul><p>And the knowledge base <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">slug</code> is manually set. This means, there needs to be a knowledge base created with the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">knowlegeBase.slug = "docs"</code> and the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">knowlegeBase.basePath = "/"</code>.</p><p><strong>app/routes/docs/($lang).tsx</strong>:</p><pre class="rounded-sm bg-secondary text-secondary-foreground p-5 font-mono font-medium"><code>import type { LoaderFunctionArgs, MetaFunction } from "react-router";\nimport KbRoutesIndex from "~/modules/knowledgeBase/routes/views/KbRoutes.Index.View";\nimport { KbRoutesIndexApi } from "~/modules/knowledgeBase/routes/api/KbRoutes.Index.Api";\nimport ServerError from "~/components/ui/errors/ServerError";\n\nexport const meta: MetaFunction = ({ data }) =&gt; data?.metatags;\nexport const loader = (args: LoaderFunctionArgs) =&gt; KbRoutesIndexApi.loader(args, {\n  kbSlug: "docs"\n});\n\nexport default () =&gt; &lt;KbRoutesIndex /&gt;;\n\nexport function ErrorBoundary() {\n  return &lt;ServerError /&gt;;\n}</code></pre><h3><strong>Dynamic Knowledge Bases</strong></h3><p>For all other knowledge bases, the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">basePath</code> needs to be <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">/help</code>. And if you need a Help Center knowledge base, you would set the <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">slug</code> as <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">center</code>. This will result in a <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">/help/center</code> route for the knowledge base.</p><p>You can change the hard-coded <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">docs</code> and <code class="rounded-md bg-secondary px-1.5 py-1 font-mono font-medium text-secondary-foreground">help</code> directories to fit your knowledge base needs.</p>',
      contentPublishedAsText:
