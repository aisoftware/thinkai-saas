          ...
          {allEntities.length > 0 && (
            <InputSelector
              ...
              hint={
                <>
                  {inputEntityId && (
                    <button type="button" onClick={() => setInputEntityId("")} className="text-muted-foreground hover:text-muted-foreground text-xs">
                      {t("shared.remove")}
                    </button>
                  )}
                </>
          ...
          {promptFlowGroups.length > 0 && (
            <InputSelector
              ...
              hint={
                <>
                  {promptFlowGroupId && (
                    <button type="button" onClick={() => setPromptFlowGroupId("")} className="text-muted-foreground hover:text-muted-foreground text-xs">
                      {t("shared.remove")}
                    </button>
                  )}
                </>
